...
/**
 * Objects of this class represent select widgets for the category.
 * The contain select buttons. If such a button is clicked, a clickt handler
 * will update the corresponding detail widget of the select widget.
 * 
 * @param <S> The category (cash, crypto or securities)
 * 
 * JAVADOC DONE
 */
public abstract class AbstractSelectWidget<S extends Selectable> extends VerticalPanel {
	...
	/**
	 * Creates a click-handler for selecting a substructure by clicking the corresponding select button.
	 * @param correspondingStructure The account, wallet or depot of the button
	 * @param clickedButton The button, where the click-handler will be registered
	 * @param allButtons The list of all buttons contained in the select widget
	 * @param detailWidget The corresponding detail widget, that will be updated
	 * @return a click-handler for selecting a substructure by clicking the corresponding select button
	 */
	 ...
	 * @param someSelectButtons all select buttons of the new widget
	 * @param detailWidget the corresponding detail widget of the new select widget
	 */
