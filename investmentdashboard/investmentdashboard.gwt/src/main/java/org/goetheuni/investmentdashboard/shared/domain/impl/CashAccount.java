...
public class CashAccount implements ICashAccount {
	 ...
	 */
	protected List<? extends CashPayment> recentPayments;
	...
	/* (non-Javadoc)
	 * @see org.goetheuni.investmentdashboard.shared.domain.api.ICashAccount#getFormattedAmount()
	 */
	@Override
	 ...
	 * @param currency
	 */
	public CashAccount(String accountID, String iban, String name, List<? extends CashPayment> recentPayments,
		...
		for (CashPayment payment : this.recentPayments) {
			if (payment.getCurrency().equals(this.getCurrency())) {
