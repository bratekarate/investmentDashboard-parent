...
public class RootStructure {
	 ...
	 * @param cryptoMarket
	 *            The list of crypto prizes used.
	 * @return the total balance in EUR incorporating all cash accounts, wallets and
	 *         depots
	 */
	...
	public static void initialize(Customer customerData) {
		...
		Objects.requireNonNull(customerData,
				"Cannot build the structure because the given Customer data object was null.");
	...
	protected RootStructure(List<CashAccountStruct> cashAccounts, List<SecurityDepotStruct> depots,
		...
		this.cashAccounts = Objects.requireNonNull(cashAccounts,
				"The list of cash account substructures must not be null");
