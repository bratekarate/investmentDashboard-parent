package org.goetheuni.investmentdashboard.service.crypto;
...
@EntityScan(basePackages = { "org.goetheuni.investmentdashboard.service.crypto" }, basePackageClasses = { AdvancedRevisionEntity.class })
